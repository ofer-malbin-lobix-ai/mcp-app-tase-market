...
async function handleSubscriptionCancelled(
  ...
  const currentMetadata = getAppSubscription(user.publicMetadata as Record<string, unknown>, APP_ID);
...
async function updateUserMetadata(
  ...
  await clerkClient.users.updateUser(userId, {
    publicMetadata: setAppSubscription(user.publicMetadata as Record<string, unknown>, data),
  });
