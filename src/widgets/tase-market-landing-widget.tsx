...
const WIDGET_REFERENCE = [
  ...
  { n: 10, widget: "my-watchlist-manager", showTool: "show-my-watchlist-manager-widget", showParams: "none", dataTools: ["get-my-watchlist", "set-my-watchlist-item", "delete-my-watchlist-item"], dataParams: ["none", "symbol, startDate, note?", "symbol"] },
...
const DATA_TOOL_REFERENCE = [
  ...
  { n: 11, tool: "get-my-watchlist", params: "none", visibility: "model, app", usedBy: "my-watchlist-manager" },
  { n: 12, tool: "set-my-watchlist-item", params: "symbol, startDate, note?", visibility: "app", usedBy: "my-watchlist-manager" },
  { n: 13, tool: "delete-my-watchlist-item", params: "symbol", visibility: "app", usedBy: "my-watchlist-manager" },
