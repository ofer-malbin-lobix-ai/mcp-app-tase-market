const t = {
  ...
  "home.desc.marketMomentum": { en: "Scored momentum scanner with persistence filtering and leader detection", he: "סורק מומנטום מדורג עם סינון עקביות וזיהוי מובילים" },
  "home.desc.marketAnticipation": { en: "Pre-uptrend setup scanner using Stochastic signals", he: "סורק מצבי טרום-מגמה באמצעות אותות סטוכסטיים" },
