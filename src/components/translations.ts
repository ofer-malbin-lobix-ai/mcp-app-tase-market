const t = {
  ...
  "landing.tool.marketAnticipation": { en: "Market Anticipation", he: "צפי שוק" },
  ...
  "landing.desc.marketAnticipation": { en: "Pre-uptrend setup scanner using Stochastic signals", he: "סורק מצבי טרום-מגמה באמצעות אותות סטוכסטיים" },
